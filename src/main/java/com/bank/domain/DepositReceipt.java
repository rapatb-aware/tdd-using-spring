...
public class DepositReceipt {
	...
	/**
	 * @param initialDestinationAccountCopy
	 *            the initialDestinationAccountCopy to set
	 */
	...
	/**
	 * @param finalDestinationAccountCopy
	 *            the finalDestinationAccountCopy to set
	 */
	...
	public String toString() {
		return "DepositReceipt{" + "depositAmount=" + depositAmount + "initialDestinationAccountCopy="
				+ initialDestinationAccountCopy + "finalDestinationAccountCopy=" + finalDestinationAccountCopy + '}';
	}
